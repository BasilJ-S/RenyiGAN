...
class GAN(object):
    def __init__(self, alpha, trial_num, version, subversion):
        ...
        self.predictions = []
        self._make_directory('data/annealing')
        self._make_directory('data/annealing/v' + str(self.version) + '-' + str(self.subversion))
        self._make_directory('data/annealing/v' + str(self.version) + '-' + str(self.subversion) + '/trial' + str(self.trial_num))
    ...
    def save_generated_images(self, sess, epoch):
        ...
        np.save('data/annealing/v' + str(self.version) + '-' + str(self.subversion) 
                + '/trial' + str(self.trial_num) + '/predictions' + str(epoch),
                self.predictions)

    def train(self, n_epochs):
        self._make_directory('checkpoints')
        self._make_directory('checkpoints/annealing/')
        self._make_directory('checkpoints/annealing/v' + str(self.version) + '-' + str(self.subversion))
        self.cpt_PATH = 'checkpoints/annealing/v' + str(self.version) + '-' + str(self.subversion) + '/trial' + str(self.trial_num)
        if self.trial_num == 1:
